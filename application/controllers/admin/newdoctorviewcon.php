<?php
class Newdoctorviewcon extends CI_Controller
{
	public function index()
	{
		...
		$this->load->view('admin/newdoctorviewconview',$data);
	...
	public function searchbyname()
	{
		if(isset($_POST['from']))
		{
			...
			$this->load->database();
			$this->load->Model('mainModel');
			$model = $this->mainModel->searchdoctor($name);
			$data['select'] = $model;
			$model = $this->mainModel->showtemp();
			$data['show']=$model;
			$this->load->view('admin/head',$data);
	...
	public function deletedata($id)
	{
		$this->load->database();
		$this->load->Model('mainModel');
		$model = $this->mainModel->deletedoctor($id);
		$data['delete'] = $model;
		$this->load->library('session');
		$data['base'] = $this->config->item('base_url');
		$model = $this->mainModel->selectdoctor();
