<?php
class Newpatientviewcon extends CI_Controller
{
...
//		$data['select'] = $model;
	$this->load->view('admin/newpatientviewconview',$data);
	...
	public function detailes($id)
	{
		...
		$model1 = $this->mainModel->patientdetails($id);
		$data['detailes'] = $model1;
		
		$model2 = $this->mainModel->selectdatapatientmodel($id);
		$data['detailes1'] = $model2;
