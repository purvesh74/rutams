 ...
 <script type="text/javascript">
								$(document).ready(function(){
									...
									$('.Mntop').hover(function(){
											$(this).find('.Mns').css('background-image','url(css/img/MenuBk.png)').css('color','#000');
    ...
    <div class="Header">
		...
		?></div>
              ...
              <div class="HeadMenu">
                ...
                <div class="Mntop"><a href="consulting.html" class="Mns">Patient And Families</a><div class="MnShd"></div>
                					 <div class="Mncon">
                 ...
                 <div class="Mntop">   <a href="products.html" class="Mns">Physician</a><div class="MnShd"></div>
                 	<div class="Mncon">
                 ...
                 <div class="Mntop"><a href="training.html" class="Mns">Our Services</a><div class="MnShd"></div></div>
              <div class="Mntop"><a href="training.html" class="Mns">Health Library</a><div class="MnShd"></div></div>
             <div class="Mntop">   <a href="products.html" class="Mns">Login</a><div class="MnShd"></div>
                 	<div class="Mncon">
