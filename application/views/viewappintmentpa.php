...
window.location = "<?php echo $base?>index.php?viewappintmentpacon/todaydata/";
...
window.location = "<?php echo $base?>index.php?viewappintmentpacon/allapp/";
...
<div class="Center">
	<div class="Scaler">
		<div class="form">
				...
				<td><div class="FormLable">  | Search By This Date  : </div><form action="'.$base.'index.php?viewappintmentpacon/searchbydate/" method="post"> 
