		...
		function onCheck()
		{
			...
			//alert(fname+lname+pass+email+contact+mobile);
				...
				$.ajax({
					...
					type:"POST",
					data: "name="+name,
					url:"<?php echo $base?>index.php?admin/newstafcat/insertdata/",
...
$('.FormBtn1').click(function (){
			...
			//alert(fname+lname+pass+email+contact+mobile);
				...
				$.ajax({
					...
					url:"<?php echo $base?>index.php?admin/newstafcat/updatedata/",
					success: function(html){
					if(html == 1)
					{
	...
	<div class="Scaler">
		<div class="form">
            ...
            if(isset($select))
            {
				foreach($select as $r)
				{
					echo '<input type="hidden" id="id" value="'.$r->c_id.'">';
				echo '<div class="Formtitle">Update Staf Category</div>
                <div class="FormLable1">Patient Name :</div><input class="FormText1" value="'.$r->cat.'"  id="name" />
                <div class="FormBtm">
			...
			?>
				<div class="Formtitle">Add Staf Category</div>
