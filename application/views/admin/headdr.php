		...
		?></div></a>
              <div class="HeadMenu">
                    ...
                    <div class="Mntop"><a href="<?php echo $base?>index.php?admin/viewdrappintmentcon/" class="Mns">Appointment</a><div class="MnShd"></div>
                					 <div class="Mncon">
                                      <div class="Mntop"><a href="<?php echo $base?>index.php?admin/adddrappintmentcon/" class="Mninr">Add Appointment</a></div>
                                      <div class="Mntop"><a href="<?php echo $base?>index.php?admin/viewdrappintmentcon/" class="Mninr">View Appointment</a></div>
                                      
                                      <a href="#" class="Mnftr"></a>
                                    </div>
                	</div> 
              
                    <div class="Mntop"><a href="<?php echo $base?>index.php?admin/Profiledr/" class="Mns">Setting</a><div class="MnShd"></div>
               
               <div class="Mncon">
                                        <div class="Mntop"><a href="<?php echo $base?>index.php?admin/Profiledr/" class="Mninr">Profile</a></div>
                                        <div class="Mntop"><a href="<?php echo $base?>index.php?admin/changepassworddrcon/" class="Mninr">Change Password</a></div>
