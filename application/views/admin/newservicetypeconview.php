...
<div class="Center">
	<div class="Scaler">
		<div class="form">
				...
				<div class="Formtitle">View Service</div>
				...
				if(isset($select))
				{
					...
					<td><div class="FormLable">Category Name</div></td>
					...
					{
					echo '<tr>
					<td><div class="FormLable">'.$row->at_id.'</div></td>
					<td><div class="FormLable">'.$row->appname.'</div></td>
					<td><a href="'.$base.'index.php?admin/newservicetype/selectdata/'.$row->at_id.'">Edit</a> | <a href="'.$base.'index.php?admin/newservicetypecon/deletedata/'.$row->at_id.'">Delete</a></td>
