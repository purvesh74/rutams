...
<div class="Center">
	<div class="Scaler">
		<div class="form">
				...
				<div class="Formtitle">View Reception<!--<div class="ri"><a href="<?php //echo $base?>index.php?admin/Newdoctorviewcon/pdfc"> Download Data </a> </div>--></div>
				...
				<td><div class="FormLable"> Search By Name : </div><form action="'.$base.'index.php?admin/receptionconview/searchbyname/" method="post"> 
			...
			<input type="submit" value="Submit" name="btnsubmit">
				...
				if(isset($select))
				{
					...
					foreach($select as $row)
					{
						...
						<td><a href="'.$base.'index.php?admin/receptioncon/selectdata/'.$row->r_id.'">Edit</a> | <a href="'.$base.'index.php?admin/receptionconview/deletedata/'.$row->r_id.'">Delete</a></td>
