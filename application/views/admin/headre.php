...
<div class="Main">
    ...
    <div class="HeaderAdmin">
		...
		?></div>
			  ...
			  ?> <a href="<?php echo $base?>index.php?home/logout" >LOGOUT</a></div> 
              <div class="Logo">  <?php 
			  if(isset($show))
	   				{
						foreach($show as $r)
		...
		?></div></a>
              <div class="HeadMenu">
                    ...
                    <div class="Mntop"><a href="<?php echo $base?>index.php?admin/viewdrappintmentcon/" class="Mns">Appointment</a><div class="MnShd"></div>
                					 <div class="Mncon">
                                      <div class="Mntop"><a href="<?php echo $base?>index.php?admin/adminhomereception/" class="Mninr">Add Appointment</a></div>
                                      <div class="Mntop"><a href="<?php echo $base?>index.php?admin/viewreappintmentcon/" class="Mninr">View Appointment</a></div>
                                      
                                      <a href="#" class="Mnftr"></a>
                                    </div>
                	</div> 
                  <div class="Mntop"><a href="<?php echo $base?>index.php?admin/viewrepatientcon/" class="Mns">Patient</a><div class="MnShd"></div>
                					 <div class="Mncon">
                                      <div class="Mntop"><a href="<?php echo $base?>index.php?admin/addpatientre/" class="Mninr">Add Patient</a></div>
                                      <div class="Mntop"><a href="<?php echo $base?>index.php?admin/viewrepatientcon/" class="Mninr">View Patient</a></div>
                                      
                                      <a href="#" class="Mnftr"></a>
                                    </div>
                	</div> 
              
                    <div class="Mntop"><a href="<?php echo $base?>index.php?admin/changepasswordrecon/" class="Mns">Setting</a><div class="MnShd"></div>
               <div class="Mncon">
                                      <div class="Mntop"><a href="<?php echo $base?>index.php?admin/profilere/" class="Mninr">Profile</a></div>
                                      <div class="Mntop"><a href="<?php echo $base?>index.php?admin/changepasswordrecon/" class="Mninr">Change Password</a></div>
