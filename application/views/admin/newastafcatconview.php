	...
	<div class="Scaler">
		<div class="form">
				...
				if(isset($select))
				{
					...
					{
						echo '<tr>
						<td><div class="FormLable">'.$row->c_id.'</div></td>
						
						<td><div class="FormLable">'.$row->cat.'</div></td>
					<td><a href="'.$base.'index.php?admin/newstafcat/selectdata/'.$row->c_id.'">Edit</a> | <a href="'.$base.'index.php?admin/newastafcatcon/deletedata/'.$row->c_id.'">Delete</a></td>
