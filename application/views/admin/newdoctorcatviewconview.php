...
<div class="Center">
	<div class="Scaler">
		<div class="form">
				...
				<div class="Formtitle">View Staf Category</div>
				...
				if(isset($select))
				{
					...
					{
						echo '<tr>
						<td><div class="FormLable">'.$row->drc_id.'</div></td>
						
						<td><div class="FormLable">'.$row->drcatname.'</div></td>
					<td><a href="'.$base.'index.php?admin/newdoctorcat/selectdata/'.$row->drc_id.'">Edit</a> | <a href="'.$base.'index.php?admin/newdoctorcatviewcon/deletedata/'.$row->drc_id.'">Delete</a></td>
