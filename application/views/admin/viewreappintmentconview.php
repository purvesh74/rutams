...
window.location = "<?php echo $base?>index.php?admin/viewreappintmentcon/todaydata/";
...
window.location = "<?php echo $base?>index.php?admin/viewreappintmentcon/allapp/";
...
function visit(id)
{
	...
	alert(id);
			$.ajax({
					type:"POST",
					data: "id="+id,
					url:"<?php echo $base?>index.php?admin/viewreappintmentcon/visitcheck/",
...
<div class="Center">
	<div class="Scaler">
		<div class="form">
				...
				<div class="Formtitle">View Appointment <div class="ri"><form action="<?php echo $base?>index.php?admin/newappointmentcon/pdfc" method="post"> Download Data By <input name="date" id="datepick" /><input type="submit" value="Ok" name="downolad" /></form> </div> </div>
				...
				<td><div class="FormLable">  | Search By This Date  : </div><form action="'.$base.'index.php?admin/viewreappintmentcon/searchbydate/" method="post"> 
...
<input type="text" id="to"  name="to" />
			<input type="submit" value="Submit" name="btnsubmit">
				...
				if(isset($select))
				{
					...
					<td><div class="FormLable">Doctor ID</div></td>
					...
					<td><a href="'.$base.'index.php?admin/adminhomereception/selectdata/'.$row->id.'">Edit</a> | <a href="'.$base.'index.php?admin/viewreappintmentcon/deletedata/'.$row->id.'">Delete</a></td>
