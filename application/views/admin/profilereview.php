	...
	<div class="Scaler">
		<div class="form">
				...
				if(isset($select))
				{
					...
					<tr>
					<td><div class="FormLable">Date</div></td><td>'.$row->registerdate.'</td>
...
<div id="popup_box">    <!-- OUR PopupBox DIV-->
       ...
       <div class="c">
      	<div class="c11"> 	
    	<?php  echo form_open_multipart('admin/Profilere/do_upload/');?>
        ...
        <div class="c1"> 	
    	 ...
    	 <form action="<?php echo $base ?>index.php?admin/Profilere/editdata/" method="post" >
			<table border="0" width="100%">
					...
					<tr>
					<td>Date</td><td><?php echo $row->registerdate ?></td>
					</tr>
					<tr>
