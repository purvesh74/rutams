		...
		function Valid(Num,Val,Obj)
		{
			...
			else
			{
				if(Num == 0)
				{
					...
					{  
						Msg +=  'Enter Service. \n';
						$('.Er').eq(Num).css('visibility','visible').text('Enter The Service. \n');
						rt = false;  
		...
		if(Blank == 0)
			...
			//alert(fname+lname+pass+email+contact+mobile);
				...
				$.ajax({
					...
					type:"POST",
					data: "name="+name,
					url:"<?php echo $base?>index.php?admin/newservicetype/insertdata/",
					success: function(html){
					if(html == 1)
					{
						alert("Service Category Save Successfully. ");
						document.getElementById("name").value = "";
						document.getElementById("name").focus();
					}
					else if(html == 0)
					{
							alert("Service Category Not Save Successfully. ");	
					}
					else
					{
...
$('.FormBtn1').click(function (){
			...
			//alert(fname+lname+pass+email+contact+mobile);
				...
				$.ajax({
					...
					url:"<?php echo $base?>index.php?admin/newservicetype/updatedata/",
					success: function(html){
					if(html == 1)
					{
						alert("Service Category Update Successfully. ")
...
//						document.getElementById("Password").focus();
					...
					{
							alert("Service Category Not Update Successfully. ");	
					}
					else
					{
							alert("Try Again Same Error. ");
	...
	<div class="Scaler">
		<div class="form">
            ...
            if(isset($select))
            {
				foreach($select as $r)
				{
					echo '<input type="hidden" id="id" value="'.$r->at_id.'">';
					echo '<div class="Formtitle">Update Service Category</div>
                	<div class="FormLable1">Category Name :</div><input class="FormText1" value="'.$r->appname.'"  id="name" />
			...
			?>
				<div class="Formtitle">Add Service Category</div>
