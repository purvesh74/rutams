...
window.location = "<?php echo $base?>index.php?admin/viewdrappintmentcon/todaydata/";
...
window.location = "<?php echo $base?>index.php?admin/viewdrappintmentcon/allapp/";
...
function visit(id)
{
	...
	alert(id);
			$.ajax({
					type:"POST",
					data: "id="+id,
					url:"<?php echo $base?>index.php?admin/viewdrappintmentcon/visitcheck/",
...
<div class="Center">
	<div class="Scaler">
		<div class="form">
				...
				<div class="Formtitle">View Appointment</div>
				...
				<td><div class="FormLable">  | Search By This Date  : </div><form action="'.$base.'index.php?admin/viewdrappintmentcon/searchbydate/" method="post"> 
