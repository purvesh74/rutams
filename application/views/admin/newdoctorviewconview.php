...
<div class="Center">
	<div class="Scaler">
		<div class="form">
				...
				<div class="Formtitle">View Doctor<div class="ri"><a href="<?php echo $base?>index.php?admin/Newdoctorviewcon/pdfc"> Download Data </a> </div></div>
				...
				<td><div class="FormLable"> Search By Name : </div><form action="'.$base.'index.php?admin/newdoctorviewcon/searchbyname/" method="post"> 
			...
			<input type="submit" value="Submit" name="btnsubmit">
				...
				if(isset($select))
				{
					...
					foreach($select as $row)
					{
						...
						<td>'.$row->degree.'</td>
						<td>'.$row->pass.'</td>
						<td>'.$row->checkup_for_patient.'</td>
						<td>'.$row->date.'</td>
						<td>'.$row->mobileno.'</td>
					
						<td>'.$row->contactno.'</td>
						<td><a href="'.$base.'index.php?admin/newdoctor/selectdata/'.$row->d_id.'">Edit</a> | <a href="'.$base.'index.php?admin/newdoctorviewcon/deletedata/'.$row->d_id.'">Delete</a></td>
