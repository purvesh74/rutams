		...
		$('.FormBtn').click(function (){
			...
			//alert(fname+lname+pass+email+contact+mobile);
				...
				$.ajax({
					...
					url:"<?php echo $base?>index.php?admin/newreceptionist/insertreception/",
					success: function(html){
					if(html == 1)
					{
						alert("New Receptionist Is Created Successfully. ")
...
//													document.getElementById("Password").focus();
					...
					{
							alert("New Receptionist Is Not Created Successfully. ");	
					}
					else
					{
...
<div class="Center">
	<div class="Scaler">
		<div class="form">
				...
				<div class="Formtitle">New Receptionist</div>
