    ...
    <div class="HeaderAdmin">
		...
		?></div></a>
              <div class="HeadMenu">
                    ...
                    <div class="Mntop"><a href="<?php echo $base?>index.php?patient/" class="Mns">Appointment</a><div class="MnShd"></div>
                					 <div class="Mncon">
                                      <div class="Mntop"><a href="<?php echo $base?>index.php?patient/" class="Mninr">Add Appointment</a></div>
                                      <div class="Mntop"><a href="<?php echo $base?>index.php?viewappintmentpacon/" class="Mninr">View Appointment</a></div>
                                      <a href="#" class="Mnftr"></a>
                                    </div>
                	</div> 
              
                    <div class="Mntop"><a href="<?php echo $base?>index.php?changepasswordpacon/" class="Mns">Change Password</a><div class="MnShd"></div>
