...
<script type="text/javascript">
	...
	var Ar = ['Enter The Full  name','Select Date','Select Date','Select Date','Enter Description','Enter The Contac no'];
		...
		function onCheck()
		{
			...
			var Contact = document.getElementById("Contact").value;
				...
				$.ajax({
					...
					url:"<?php echo $base?>index.php?patient/insertdata/",
...
$('.FormBtn1').click(function (){
			...
			document.getElementById("Doctorename").focus();
					...
					{
							alert("Appointment not Update Successfully. ");	
					}
					else
					{
							alert("Try Again Same Error. ");
		...
		<div class="form">
            ...
            if(isset($select))
            {
                ...
                <div class="FormLable1">Description :</div><input class="FormText1" value="'.$r->description.'" id="dsc" />
               	               	<div class="FormLable1">Contact :</div><input class="FormText1" onkeypress="return nokey(event)" value="'.$r->app_contactno.'" id="Contact" />
